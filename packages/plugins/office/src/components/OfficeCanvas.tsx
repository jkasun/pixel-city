...
import type { EditorState } from '@pixel-city/shared/office/editor/editorState'
import {
  paintTile,
  placeFurniture,
  removeFurniture,
...
export interface OfficeCanvasProps {
  ...
  onPushUndo?: () => void
  /** Called when canvas internally mutates editorState (selection, tool, etc.) so parent can re-render */
...
export function OfficeCanvas({
  ...
  const handleClick = useCallback(
    ...
    [officeState, onClick, screenToWorld, screenToTile, screenToTileUnclamped, isEditMode, editorState, applyLayout, pushUndoAndApply, zoom, onEditorStateChange],
  )
  ...
  const handleKeyDown = useCallback(
    ...
    [isEditMode, editorState, officeState, pushUndoAndApply, onEditorStateChange],
  )
