...
export const FURNITURE_CATALOG: CatalogEntryWithCategory[] = [
  ...
  { type: FurnitureType.TALL_PLANT,     label: 'Tall Plant',     footprintW: 1, footprintH: 2, sprite: TALL_PLANT_SPRITE,      isDesk: false, category: 'decor' },
  { type: FurnitureType.SUCCULENT,      label: 'Succulent',      footprintW: 1, footprintH: 1, sprite: SUCCULENT_SPRITE,       isDesk: false, category: 'decor' },
  { type: FurnitureType.CACTUS,         label: 'Cactus',         footprintW: 1, footprintH: 1, sprite: CACTUS_SPRITE,          isDesk: false, category: 'decor' },
  ...
  { type: FurnitureType.PAINTING,       label: 'Painting',       footprintW: 1, footprintH: 1, sprite: PAINTING_SPRITE,        isDesk: false, category: 'wall' },
  ...
  { type: FurnitureType.LEAFY_PLANT,   label: 'Leafy Plant',   footprintW: 1, footprintH: 2, sprite: LEAFY_PLANT_SPRITE,     isDesk: false, category: 'decor' },
