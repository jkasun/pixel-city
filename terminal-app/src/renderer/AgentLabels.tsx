...
export function AgentLabels({ officeState, agentStatusMap, agentWorkerStatusMap, containerRef, zoom, panRef }: AgentLabelsProps) {
  ...
  // Throttle label position updates to ~20fps instead of 60fps.
  // Agent labels track character walking positions which don't need
  // full frame-rate rendering.
  useEffect(() => {
    let rafId = 0
    const tick = () => {
  ...
  // Hover name tag for permanent employees
  ...
  return (
    <>
      {/* Status labels for active agents */}
