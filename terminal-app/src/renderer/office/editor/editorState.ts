...
import type { TileType as TileTypeVal, OfficeLayout, FloorColor } from '@pixel-city/shared/office/types'
import { UNDO_STACK_MAX_SIZE, DEFAULT_FLOOR_COLOR, DEFAULT_WALL_COLOR } from '@pixel-city/shared/constants'
